<html lang="ja">
    ...
    <body id>
       ...
       <a href="https://twitter.com/@oO48931155" class="btn twitter"><i class="fab fa-twitter"></i></a>
        ...
        <div class="helpbox">
        <form action="confirm_home.php" method="post" name="form" onsubmit="return validate()">
        <h1 class="icon">CONTACT</h1>
        <div>
            <div class="dname">
                <label>Name</label>
                <input type="text" name="name" class="name" placeholder="例）山田太郎" value="">
            </div>
            <div class="demail">
                <label>メールアドレス</label>
                <input type="text" name="email" class="text" placeholder="例）guest@example.com" value="">
            </div>
            <div class="dcontent">
                <label>メッセージ</label>
                <textarea name="contentbox" class="contentbox" rows="5" placeholder=""></textarea>
            </div>
        </div>
